...
interface ContactModalProps {
  onClose:    () => void
  onCreated?: (contact: SageContact) => void
}
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="title" type="text" placeholder="e.g. CEO, Marketing Lead" className={inputCls} />
                </div>
                <div>
                  <label className={labelCls}>Contact Type</label>
                  <select name="contact_type" defaultValue="potential_customer" className={inputCls}>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input name="website_url" type="url" placeholder="https://acme.com" className={inputCls} />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="company_name" type="text" placeholder="Acme Corp" className={inputCls} />
                </div>
                <div>
                  <label className={labelCls}>Business Goal</label>
                  <input name="business_goal" type="text" placeholder="e.g. Automate support" className={inputCls} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input name="street" type="text" placeholder="123 Main St" className={inputCls} />
              </div>
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className={labelCls}>City</label>
                  <input name="city" type="text" placeholder="New York" className={inputCls} />
                </div>
                <div>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="tags" type="text" placeholder="hot-lead, enterprise" className={inputCls} />
                </div>
                <div>
                  <label className={labelCls}>Visibility</label>
                  <select name="visibility" defaultValue="everyone" className={inputCls}>
              ...
              <div>
                ...
                <textarea name="notes" rows={3} placeholder="Any additional context…" className={`${inputCls} resize-none`} />
              </div>
            </div>
          </div>
