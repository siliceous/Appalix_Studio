        ...
        {members && members.length > 0 && (
          <div className="relative">
            <select
              ...
              disabled={assigning}
              className="appearance-none pl-2.5 pr-7 py-1.5 text-xs border dark:border-white/10 rounded-lg bg-white dark:bg-white/5 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/8 focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-[#15A4AE] transition-colors disabled:opacity-50 max-w-[140px]"
            >
