...
export function SubpageToolbar({ sourceKey, preset, autoEnabled, customFrom, customTo }: Props) {
  ...
  return (
    <nav className="px-4 border-b dark:border-white/8 bg-white dark:bg-[#1c1c1c] flex items-center shrink-0 gap-4 min-h-[52px] overflow-hidden">
      {/* Overview link + page pill buttons */}
      <div className="flex items-center gap-1.5 min-w-0 overflow-x-auto shrink-1 scrollbar-hide">
        <Link
          href="/dashboard"
