  ...
  return (
    <div className="flex flex-1 overflow-hidden">
            ...
            {(unanalyzedCount > 0 || selectedIds.size > 0) && (
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  title={selectedIds.size > 0 ? `Re-analyse ${selectedIds.size} selected` : 'Run AI analysis on unanalyzed emails'}
            ...
            visible.map(t => {
              ...
              return (
                <div key={t.email.id}
                  ...
                  <div className="flex-1 text-left min-w-0 px-3 py-2.5">
                  ...
                  <div className="flex flex-col items-end justify-start gap-2 pt-2.5 pb-2.5 pr-3 shrink-0">
                    ...
                    <button onClick={() => toggleSelect(t.email.id)} title={isChecked ? 'Deselect' : 'Select'}>
                      <span className={cn(
                        'w-4 h-4 rounded border flex items-center justify-center transition-colors',
                        isChecked ? 'bg-[#61c2ad] border-[#61c2ad]' : 'border-gray-300 dark:border-white/20 hover:border-[#61c2ad]',
                      )}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-gray-50 dark:bg-[#1c1c1c]">
        ...
        {/* ── Modal overlay (slides up from bottom of center panel) ── */}
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[11px] text-gray-400 mt-0.5">
                  From: {modalEmail.email.from_name ?? modalEmail.email.from_address}
                </p>
              </div>
