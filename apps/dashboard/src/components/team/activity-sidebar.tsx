...
export function ActivitySidebar({ activity, date, currentPath, viewingAs, className }: Props) {
  ...
  // ── Expanded ───────────────────────────────────────────────────────────────
  return (
    <div className={className ?? 'w-64 flex-shrink-0 bg-[#f5f4f1] dark:bg-[#1c1c1c] flex flex-col overflow-hidden p-3 pr-4'}>
