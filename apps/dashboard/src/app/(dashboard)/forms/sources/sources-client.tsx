...
export function SourcesClient({ sources: initialSources, workspaceId, baseUrl }: SourcesClientProps) {
  ...
  const inputCls   = 'w-full px-3 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-white/5 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-[#61c2ad]'
