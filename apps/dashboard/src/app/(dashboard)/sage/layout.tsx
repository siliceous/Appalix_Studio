  ...
  if (!isPro) {
    return (
      <div className="flex flex-col items-center justify-center h-full py-24 px-6 text-center relative overflow-hidden -m-8">
        <div className="pointer-events-none absolute -top-20 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-[#15A4AE]/[0.06] blur-[120px] dark:block hidden" />
        <div className="pointer-events-none absolute bottom-0 left-1/4 w-[300px] h-[300px] rounded-full bg-[#15A4AE]/[0.04] blur-[100px] dark:block hidden" />
        <div className="w-16 h-16 rounded-2xl bg-brand-50 dark:bg-[#15A4AE]/10 border border-brand-200 dark:border-[#15A4AE]/20 flex items-center justify-center mb-6 relative z-10">
          <Sparkles className="w-7 h-7 text-brand-600 dark:text-[#15A4AE]" />
        </div>
