              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-white/[0.03] rounded-xl border dark:border-white/8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mt-0.5">{formatDateTime(ticket.created_at)}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    {ticket.occurred_at && (
                      <div className="p-2.5 bg-gray-50 dark:bg-white/[0.03] rounded-xl border dark:border-white/8">
                        ...
                        <p className="text-xs font-medium text-gray-900 dark:text-gray-100">{formatDate(ticket.occurred_at)}</p>
                      </div>
                    )}
                  </div>
                </div>
                              ...
                              <div key={act.id} className="flex items-start gap-2 rounded-lg border dark:border-white/8 p-2.5 bg-gray-50 dark:bg-white/[0.02]">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center justify-between mt-1">
                                    <span className="text-[10px] text-amber-600 dark:text-amber-400">Due {formatDate(act.due_at)}</span>
                                    {!readonly && (
