      ...
      <form action={action} className="space-y-5">
        ...
        <div className="bg-white dark:bg-[#2a2a2a] rounded-xl border dark:border-white/10 p-5 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">Choose a skin for your embedded chat widget. Use arrows to browse, or pick Custom to use your brand colours.</p>
          </div>
          <SkinPicker
            defaultSkin={bot.widget_skin ?? 'light'}
