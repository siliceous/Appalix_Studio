          ...
          return (
            <div key={s.id} className="flex items-center gap-2 flex-1">
              <div className={cn(
                ...
                done    ? 'bg-brand-50 dark:bg-[#61c2ad]/10 text-brand-700 dark:text-brand-400'  : '',
                !active && !done ? 'bg-gray-100 dark:bg-white/5 text-gray-400 dark:text-gray-500' : '',
              )}>
                <div className={cn(
                  'w-5 h-5 rounded-full flex items-center justify-center shrink-0',
                  active ? 'bg-white/20' : done ? 'bg-brand-100 dark:bg-[#61c2ad]/20' : 'bg-gray-200 dark:bg-white/10',
                )}>
                  {done
      ...
      <div className="bg-white dark:bg-[#2a2a2a] rounded-xl border dark:border-white/10 overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4 border-b dark:border-white/10">
          <div className="flex items-center gap-3">
            {(() => { const Icon = STEPS[step].icon; return <div className="w-9 h-9 rounded-xl bg-brand-50 dark:bg-[#61c2ad]/10 flex items-center justify-center"><Icon className="w-4.5 h-4.5 text-brand-600 dark:text-[#61c2ad]" /></div> })()}
            <div>
              ...
              {([
                ...
                >
                  <div className={cn(
                    ...
                    form.bot_type === value ? 'bg-brand-100 dark:bg-[#61c2ad]/10' : 'bg-gray-100 dark:bg-white/5',
                  )}>
                    <Icon className={cn('w-4 h-4', form.bot_type === value ? 'text-brand-600 dark:text-[#61c2ad]' : 'text-gray-400')} />
                  </div>
                  <p className={cn('text-sm font-semibold mb-1', form.bot_type === value ? 'text-brand-700 dark:text-[#61c2ad]' : 'text-gray-900 dark:text-gray-100')}>{label}</p>
