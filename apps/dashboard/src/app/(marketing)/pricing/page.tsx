...
export const metadata: Metadata = { title: 'Pricing — Appalix' }
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <div className="mb-6">
                <span className={`text-3xl font-black ${plan.popular ? 'text-white' : 'text-white'}`}>
                  {plan.price}
                </span>
      ...
      <section className="py-20 px-6 border-t border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {FAQS.map((faq) => (
              <div key={faq.q} className="p-6 rounded-2xl bg-white/5 border border-white/10">
