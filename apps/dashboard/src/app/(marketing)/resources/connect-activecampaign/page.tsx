    ...
    <div className="pt-24 pb-24 px-6">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-sm text-white/60 mb-10">
          ...
          <span>/</span>
          <span className="text-white/65">Connect ActiveCampaign</span>
        </div>
          ...
          <section>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-sm text-white/65 mt-1">All ActiveCampaign plans include API access. The API URL and API Key are available on every plan under Settings → Developer.</p>
              </div>
              <div>
                <p className="font-semibold text-white">Will existing ActiveCampaign contacts be updated?</p>
                <p className="text-sm text-white/65 mt-1">Yes. ActiveCampaign uses email as the unique identifier. If a contact with the same email already exists, it is updated rather than duplicated.</p>
              </div>
              <div>
                <p className="font-semibold text-white">Are my API credentials stored securely?</p>
                <p className="text-sm text-white/65 mt-1">Yes. Your API Key is stored encrypted in your workspace database and never exposed in plain text after saving.</p>
              </div>
              <div>
                <p className="font-semibold text-white">Can I use ActiveCampaign&apos;s built-in CRM alongside Appalix Sage?</p>
                <p className="text-sm text-white/65 mt-1">Yes. Appalix pushes contact data and you can use ActiveCampaign&apos;s own deals and pipelines independently. The two systems complement each other.</p>
              </div>
            </div>
          </section>
