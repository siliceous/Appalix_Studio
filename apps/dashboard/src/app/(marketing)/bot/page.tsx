      ...
      <div className="relative rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-5 py-3 bg-gray-100 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2 px-4 py-1 rounded-md bg-white border border-gray-200">
            <span className="text-xs text-white/65">app.appalix.ai/bots</span>
          </div>
          <div className="w-16" />
        </div>
          ...
          <div className="max-w-5xl mx-auto px-5 py-5">
            ...
            <div className="flex items-start justify-between mb-5">
              <div>
                ...
                <p className="text-[11px] text-white/60 mt-0.5">Configure AI agents and connect them to platforms</p>
              </div>
              ...
              {BOTS.map(bot => (
                <Tip key={bot.id} label={`${bot.name} — click to edit, manage integrations, and view analytics`} dir="top" clickable>
                  ...
                  >
                    ...
                    <p className="text-[9px] text-white/60 line-clamp-2 mb-3">{bot.desc}</p>
            ...
            <div className="mb-4">
              ...
              <p className="text-[11px] text-white/60">Your workspace activity at a glance</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
                    ...
                    <Tip key={i} label="Click to open conversation — full transcript, lead info, and AI summary" dir="top" clickable>
                      <div className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors cursor-default">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[9px] text-white/60 mt-0.5">{c.msgs} messages · {c.time}</p>
                        </div>
                        <span className={`text-[9px] font-medium px-1.5 py-0.5 rounded-full shrink-0 ${PLATFORM_COLOR[c.platform] ?? 'bg-gray-100 text-white/60'}`}>{c.platform}</span>
                      </div>
                    </Tip>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-4 space-y-4">
                  <div>
                    <p className="text-[10px] text-white/60 mb-1">Tokens consumed</p>
                    <p className="text-xl font-bold text-gray-900">2.4M</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-white/60 mb-1">Estimated cost</p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="relative w-full max-w-lg bg-[#222] border border-white/10 rounded-2xl p-8 shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-sm text-white/65 leading-relaxed mb-7">Deploy your first AI bot to your website or WhatsApp in under 5 minutes — no coding required.</p>
    ...
    <div className="bg-[#1c1c1c] min-h-screen text-white">
      <section className="relative pt-36 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <FadeUp delay={0.2}><p className="text-base sm:text-xl text-white/65 leading-relaxed max-w-2xl mx-auto mb-10">Build, train, and deploy AI chatbots that capture leads, answer questions, and resolve support queries — 24/7 across web, WhatsApp, FB messenger, Slack and more.</p></FadeUp>
      ...
      <section className="py-20 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal className="text-center mb-14"><p className="text-xs text-brand-400 uppercase tracking-widest font-semibold mb-3">Bot Intelligence</p><h2 className="text-3xl sm:text-4xl font-bold mb-4">Your 24/7 AI sales &amp; support team</h2><p className="text-white/65 max-w-xl mx-auto text-sm leading-relaxed">Deploy once, run everywhere. Your bots handle the conversations while you focus on closing deals.</p></ScrollReveal>
      ...
      <section className="py-24 px-6 border-t border-white/5 text-center">
        <ScrollReveal><h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to deploy your first bot?</h2><p className="text-white/65 mb-8 text-sm max-w-md mx-auto">Takes 5 minutes. No code. Works on any website.</p><Link href="/login" className="inline-block px-8 py-4 bg-[#1a8c76] hover:bg-[#14705d] text-white font-medium rounded-xl transition-colors text-sm">Start free trial →</Link></ScrollReveal>
      </section>
