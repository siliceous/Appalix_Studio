    ...
    <div className="bg-[#1c1c1c] min-h-screen text-white">
      <section className="relative pt-36 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <FadeUp delay={0.2}><p className="text-base sm:text-xl text-gray-400 leading-relaxed max-w-2xl mx-auto mb-10">Build, train, and deploy AI chatbots that capture leads, answer questions, and resolve support queries — 24/7 across web, WhatsApp, FB messenger, Slack and more.</p></FadeUp>
