  ...
  return (
    <main className="bg-[#111] min-h-screen text-white pt-16">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        <ScrollReveal>
          <h2 className="text-2xl font-bold text-center mb-10">Built for fast support teams</h2>
            ...
            {[
              {
                ...
                desc: 'Urgent, High, Medium and Low priorities with colour-coded labels. Change priority inline without opening the ticket.',
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                ...
                desc: 'Assign any ticket to a team member with a single click. See who owns what at a glance — no spreadsheets needed.',
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                ...
                desc: 'Select two or more tickets and merge them into one. Keep the primary thread, close the rest automatically.',
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                ...
                desc: 'Full-text search across ticket title, description, and contact name — results appear as you type.',
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                ...
                title: 'CSV Export',
                desc: 'Export your full ticket history to CSV for reporting, audits, or migrating to another system.',
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                ...
                desc: 'Open → In Progress → Pending → Resolved → Closed. Update status inline on every row without leaving the list.',
              },
            ].map((c, i) => (
