...
export const SAGE_LIVE_FUNCTION_DECLARATIONS = [
  ...
  {
    name: 'navigate_to',
    description: "Navigate the user to a page in the Appalix app. Use this when the user explicitly says 'go to', 'take me to', 'open the X page', or 'navigate to'. Do NOT call this just because the user asks about data — use the query tools instead. NOTE: If the user says 'open pipeline X' by name, use open_pipeline instead. If the user says 'open deal X', use open_deal instead. IMPORTANT: SMS and Phone Calls are SEPARATE pages from Conversations — never navigate to /conversations for SMS or phone requests. Available paths and their labels — Dashboard: /dashboard, Emails (triage): /dashboard/email, Bot Conversations (chatbot activity): /dashboard/bots, SMS (text messages): /dashboard/sms, Phone Calls (voice calls): /dashboard/calls, Forms activity: /dashboard/forms, Tickets activity: /dashboard/tickets, Pipelines/CRM: /sage/pipelines, Contacts: /sage/contacts, Projects: /sage/projects, Quotes & Invoices: /sage/quotes, Tickets: /sage/tickets, Emails (inbox): /sage/emails, ROI: /sage/roi, Rules/Automation: /sage/rules, Integrations (Sage): /sage/integrations, Bots: /bots, Integrations: /integrations, Knowledge Base/Sources: /sources, Forms: /dashboard/forms, Analytics: /analytics, My Activity: /my-activity, Settings (general): /settings — NOTE: there is NO /settings/general path, always use /settings for the main settings page. Settings > Profile: /settings/profile, Settings > Sage Voice: /settings/sage-voice, Settings > Automation: /settings/automation, Settings > Branding: /settings/branding, Settings > Invite: /settings/invite, Settings > Upgrade/billing: /settings/upgrade.",
    parameters: {
      type: 'OBJECT',
      properties: {
